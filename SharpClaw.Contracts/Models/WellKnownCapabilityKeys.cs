...
///
/// Capability tags are free-form strings — registrations and providers may
...
/// registrations and capability-aware UI.
/// </summary>
public static class WellKnownCapabilityKeys
{
    ...
    /// <summary>The model supports vision (image) inputs. Convention used by provider registrations.</summary>
    public const string Vision = "vision";

    /// <summary>The model produces embeddings. Convention used by provider registrations.</summary>
    public const string Embedding = "embedding";

    /// <summary>The model produces speech audio (text-to-speech). Convention used by provider registrations.</summary>
    public const string Tts = "tts";

    /// <summary>The model generates images. Convention used by provider registrations.</summary>
