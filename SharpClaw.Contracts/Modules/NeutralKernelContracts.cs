...
/// <summary>One versioned feature value declared by a module.</summary>
...
/// <summary>Effective action capabilities granted to one module hook.</summary>
...
/// <summary>Effective event capabilities granted to one module listener or interceptor.</summary>
...
/// <summary>Identity of one loaded module.</summary>
public sealed record ModuleIdentity(
    string Id,
    string DisplayName,
    string ToolPrefix);

/// <summary>Host context supplied when a module starts.</summary>
...
/// <summary>Exclusive registration for one resolver or coordinator slot.</summary>
public sealed record ExclusiveRegistration(string Id);

/// <summary>One module-owned feature contract and its transport limit.</summary>
public sealed record ModuleFeatureDescriptor(
    string ContractName,
    int SchemaVersion,
    string OwnerModuleId,
    int MaxBytes,
