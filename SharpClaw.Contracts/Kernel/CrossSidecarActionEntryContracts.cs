...
public sealed record SidecarActionEntryDefinition(
    string SourceId,
    string GraphId,
    SidecarActionDescriptorIdentity Descriptor,
    string TerminalOwnerId,
    string TerminalOwnerGraphId)
{
    public bool IsWellFormed =>
        ...
        !string.IsNullOrWhiteSpace(TerminalOwnerId) &&
        !string.IsNullOrWhiteSpace(TerminalOwnerGraphId) &&
        string.Equals(TerminalOwnerId, SourceId, StringComparison.Ordinal) &&
...
/// <summary>Neutral child request. It carries no target registration or host descriptor authority.</summary>
    ...
    string Proof)
{
    ...
    public bool IsValid =>
        ...
        !string.IsNullOrWhiteSpace(TerminalOwnerId) &&
        !string.IsNullOrWhiteSpace(TerminalOwnerGraphId) &&
        string.Equals(TerminalOwnerId, TargetEntry.SourceId, StringComparison.Ordinal) &&
...
public enum SidecarHostTerminalCancellationState
{
    None = 0,
    Cancelled = 1,
}
    ...
    DateTimeOffset CancelledAt)
{
    public bool IsWellFormed =>
        ...
        TerminalAuthority.CancellationState == SidecarHostTerminalCancellationState.Cancelled &&
        TerminalAuthority.CancellationAt == CancelledAt &&
        TerminalAuthority.IssuedAt <= CancelledAt &&
        CancelledAt <= TerminalAuthority.ExpiresAt &&
...
public static class SidecarCrossSidecarActionEntryValidation
{
        ...
        DateTimeOffset now)
    {
        ...
        if (!request.IsWellFormed ||
            ...
            !string.Equals(parentCall.SourceId, sourceBinding.SourceId, StringComparison.Ordinal) ||
        ...
        Func<SidecarCrossSidecarActionEntryAuthority, string, bool> authenticate)
    {
        ...
        if (!carrier.IsWellFormed ||
            ...
            !string.Equals(authority.TargetChildCall.SourceId, targetBinding.SourceId, StringComparison.Ordinal) ||
            ...
            authority.TargetEntry.SourceId != targetBinding.SourceId ||
