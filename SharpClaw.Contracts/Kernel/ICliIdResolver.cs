...
/// <summary>
/// Provides short-ID ↔ GUID resolution and JSON output for registration CLI handlers.
/// Registered by the host; registrations resolve via <see cref="IServiceProvider"/>.
/// </summary>
