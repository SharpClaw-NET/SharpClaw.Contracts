...
/// <summary>
/// Per-registration persistent key-value configuration store.
/// Registrations resolve this from DI — the host provides a scoped instance
/// bound to the calling registration's ID.
/// </summary>
public interface IConfigurationStore
{
    ...
    /// <summary>Get all configuration keys and values for this registration.</summary>
